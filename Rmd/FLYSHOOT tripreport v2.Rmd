...
# setvessel<-"SL9"   ;settrip<-c("2023091200046","2023091800047") ;
# setvessel<-c("Z99", "SCH99")   ;settrip<-"2023003" ;

# ------------------------------------------------------------

setvessel<-"SL9"   ;startdate<-dmy("22/11/2023"); enddate <- dmy("29/11/2023") ;
# setvessel<-"SCH65"   ;startdate<-dmy("27/11/2023"); enddate <- dmy("30/11/2023") ;
# setvessel<-"SCH135"   ;startdate<-dmy("29/11/2023"); enddate <- dmy("30/11/2023") ;
