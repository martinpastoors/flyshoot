...
setvessel<-"SL9"   ;settrip<-c("2023434","2023435","2023436") ;
...
if (nrow(m) > 0) {
  ...
  s <-
    elog %>% 
    filter(vessel %in% setvessel, year == 2023) %>% 
...
```{r catchperhaul3, echo=FALSE, fig.asp=1.0, fig.align="center", message=FALSE, warning=FALSE}
...
```{r catchperhaul4, echo=FALSE, fig.asp=1.0, fig.align="center", message=FALSE, warning=FALSE}
