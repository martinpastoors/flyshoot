...
# setvessel<-"SCH135"   ;settrip<-c("2023348","2023349") ; comparisons <- TRUE
# setvessel<-"SCH65"   ;settrip<-c("2023264","2023265") ; comparisons <- FALSE
setvessel<-"SL9"   ;settrip<-c("2023437","2023438","2023439", "2023441") ; comparisons <- TRUE
...
tab_nums(
  ...
  level = 1, display = FALSE,
  caption = "Vangst per soort (kg) reis en bron (alleen vangsten groter dan 20 kg)")
