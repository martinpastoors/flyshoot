...
setvessel<-"SCH135"   ;settrip<-c("2023367") ; comparisons <- FALSE
# setvessel<-"SCH65"   ;settrip<-c("2023281", "2023282") ; comparisons <- FALSE
# setvessel<-"SL9"   ;settrip<-c("2023081600041", "2023082100042") ; comparisons <- FALSE
# setvessel<-c("Z99", "SCH99")   ;settrip<- c( "2023097") ; comparisons <- FALSE
...
h <- 
  ...
  # TEMP FIX
  mutate(lon = ifelse(lon>2, -1*lon, lon)) %>% 
